...
# global headers a serem usados â€‹â€‹para solicitaÃ§Ãµes
...
def extract_movies(soup):
    ...
    # ModificaÃ§Ã£o realizada devido erro AttributeError: 'NoneType' object has no attribute 'find', pois a 'div' nÃ£o estava sendo encontrada
    ...
    if movies_table_div is not None:
        ...
        print('A div com o atributo data-testid igual a chart-layout-main-column nÃ£o foi encontrada')
...
def main():
    ...
    #FunÃ§Ã£o principal para extrair 100 filmes do IMDB Most Popular Movies
    extract_movies(soup)
